...
export default function About() {
  ...
  const title = 'About Madelyn | Madelyn Hotchkiss Esthetics'
  const desc = 'Licensed esthetician in the Portland metro area specializing in acne and age‑positive skincare. Gentle, personalized facials. Book Now!'
  ...
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{`${about.jsonld}`}</script>
      </Helmet>
